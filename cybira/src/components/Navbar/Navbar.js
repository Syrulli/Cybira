  ...
  return (
    <nav className="navbar navbar-expand-lg sticky-top">
      <div className="container-fluid">
        <a className="navbar-brand fw-bold fs-2 p-lg-4 ps-lg-5 p-xxl-5 text-white" href="/" style={{ fontSize: '2rem' }}>
          Cybira
        </a>
        <button
        ...
        <div className="collapse navbar-collapse justify-content-between" id="navbarContent">
          ...
          <li className="nav-item mt-lg-2">
              <Link className="nav-link position-relative text-white" to="/Cloud_architecture">  
                Cloud Architecture
              </Link>
            </li>
            <li className="nav-item mt-lg-2">
